...
<body>
<div class="container">
<nav class="navbar navbar-dark bg-dark" id="navbar-bg" style="background-color:#66ff99;">
<div class="navbar-header">
				<a href="" class="navbar-brand"><img src="<c:url value='/resources/images/logo1.png'></c:url>" alt="HEALTH PLUS" height="30"px" width="60px"></a>
...
<li><a href="<c:url value='/all/getallproducts'></c:url>">Browse all products</a></li>
  <li class="dropdown"><a href="#" class="dropdown-toggle"
					data-toggle="dropdown">Select By Brand<span class="caret"></span></a>
